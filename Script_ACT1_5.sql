...
AS
	BEGIN
		INSERT INTO ARTICULOS(descripcion) VALUES (@descripcion) 
	END
...
AS
	BEGIN
		SELECT id_articulo, descripcion FROM ARTICULOS
	END
...
AS
	BEGIN
		SELECT id_articulo, descripcion FROM ARTICULOS WHERE id_articulo = @id
	END
...
INSERT INTO ARTICULOS(descripcion) values ('MILANESA')
INSERT INTO ARTICULOS(descripcion) values ('HAMBURGUESA')
INSERT INTO ARTICULOS(descripcion) values ('MEDALLON.POLLO')
